...
const weatherAlertHistorySchema = new mongoose.Schema({
  ...
  kind: { type: String, enum: ['heavy-rain', 'severe-weather', 'risk-intelligence'], required: true },
  sentAt: { type: Date, required: true, default: Date.now },
  severityAmountMm: { type: Number, default: 0 },
  locationKey: { type: String, required: true },
  eventEnd: { type: Date, default: null },
  severityLevel: { type: String, default: 'Informational' },
  riskSignature: { type: String, default: '' },
  hazard: { type: String, default: '' },
